...
class dekbedSpider(Spider):
    name = "wehkamp_dekbedovertrekken"
    start_urls = ['https://www.wehkamp.nl/wonen-slapen/beddengoed/dekbedovertrekken/C28_8H3_H30/']
    # start_urls = ['https://www.wehkamp.nl/wonen-slapen/beddengoed/kinderdekbedovertrekken/C28_8H3_HCX/']
    ...
    def parse(self, response):
        ...
        if page < 14:
            page += 1
            url = 'https://www.wehkamp.nl/wonen-slapen/beddengoed/dekbedovertrekken/C28_8H3_H30/?PI={}'.format(page)
        ...
        try:
            ...
            for option in jsondata:
                if option['selected']:
                    ...
                    yield Request('https://www.wehkamp.nl/service/product-components/api/pdps/{}?sizeCode={}&CC=C28&SC=8H3&KAC=HCX'.format(id, code), self.finalOption, meta={'item':item})
        except:
            yield item
    def finalOption(self, response):
        ...
        for attr in properties:
            if attr['label'] == "Materiaal":
                item['Materiaal'] = attr['value']
