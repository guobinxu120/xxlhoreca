...
class dekbedSpider(Spider):
    name = "textielhuis_dekbedden"
    start_urls = ['https://www.textielhuis.nl/beddengoed/dekbedden']
    ...
    def finalParse(self, response):
        ...
        attrs = response.xpath('//table[@class="table table-bordered attribute"]/tbody/tr')
        item['Materiaal'] = ''
        item['Uitvoering'] = ''
        item['Warmteklasse'] = ''
        for tr in attrs:
