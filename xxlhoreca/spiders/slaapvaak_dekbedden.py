...
class dekbedSpider(Spider):
    name = "slaapvaak_dekbedden"
    start_urls = ['https://www.slaapvaak.nl/slaapkamer/dekbedden/']
        ...
        if option_tags:
            ...
            for option_tag in option_tags:
                ...
                if selected:
                    ...
                    item['rating'] = response.xpath('//meta[@itemprop="rating"]/@content').extract_first()
                    reviews = response.xpath('//a[@class="show-reviews"]/text()').re(r'[\d]+')
                    if reviews:
